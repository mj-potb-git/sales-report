    ...
    <div className="flex flex-col gap-5 max-w-6xl mx-auto w-full">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-gray-400">Meta Ads — which ads bring cheap leads, and which to turn off · {periodLabel}</p>
        </div>
        ...
        return (
          <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              ...
              <Kpi icon={Target} label="Leads + Chats" value={summary.totalResults.toLocaleString()} sub={`${summary.totalLeads} leads · ${summary.totalMsg} messenger`} accent={GOLD} />
            ...
            <p className="text-[11px] text-gray-400 text-center">
              "Leads" = lead form/website · "Chats" = Messenger conversations started · Cost/Lead = spend ÷ (leads + chats) ·
              CTR = link clicks ÷ impressions · Freq = avg times shown per person (≥4 = fatigue). Click an ad name to open it in Meta Ads Manager.
              Recommendations are based on active ads only; the final decision is yours.
            </p>
          </>
        )
      })()}
